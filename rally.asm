...
Room1
        ...
        .byte #%00000100, #%00000010, #0
        .byte #%00000110, #%10000111, #0
        .byte #%00000011, #%10000011, #100
        .byte #%00010000, #%00000111, #0
        .byte #%00001000, #%00000110, #0
        .byte #%00000000, #%00001000, #0
        .byte #%11100000, #%00010000, #0
        .byte #%11111000, #%00000000, #0
        .byte #%11110000, #%00000100, #0
        .byte #%11110011, #%00000111, #0
        .byte #%11111111, #%01000111, #0
        .byte #%11111111, #%01000111, #0
        .byte #%11111111, #%01001111, #0
        .byte #%11111111, #%11011111, #0
        .byte #%11111111, #%11111111, #0

Room2
        .byte #%00000000, #%00000000, #0
        .byte #%00000111, #%00000000, #0
        .byte #%00011111, #%00000001, #0
        .byte #%00011111, #%00000000, #90
        .byte #%00011111, #%00000000, #0
        .byte #%00011111, #%00000001, #0
        .byte #%00011111, #%01000011, #0
        .byte #%00000111, #%00000011, #0
        .byte #%00000011, #%00000011, #0
        .byte #%00000011, #%00000011, #0
        .byte #%00000011, #%00000011, #0
        .byte #%00000001, #%00000001, #0
...
Room3
        .byte #%11111111, #%00000011, #0
        .byte #%11111111, #%00000111, #0
        .byte #%11111111, #%00001111, #0
        .byte #%11111111, #%00011111, #80
        .byte #%11111111, #%00111111, #0
        .byte #%11111111, #%00111111, #0
        .byte #%11111111, #%00111111, #0
        .byte #%11111111, #%00111111, #0
        .byte #%11111111, #%00111111, #0
        .byte #%11111111, #%00011111, #0
        .byte #%11111111, #%00001111, #0
        .byte #%11111111, #%00001111, #0
        .byte #%11111111, #%00000011, #0
        .byte #%11111111, #%00000001, #0
        .byte #%11111110, #%00000000, #0
        .byte #%10000000, #%00000000, #0

Room4
        .byte #%11000111, #%11100011, #0
        .byte #%11000111, #%11100001, #0
        .byte #%11100011, #%11100001, #0
        .byte #%11110000, #%00110001, #90
        .byte #%11111000, #%00010000, #0
...
Room5
        .byte #%11000001, #%11111111, #0
        .byte #%11000001, #%00000000, #0
        .byte #%01000001, #%01000000, #0
        .byte #%00000000, #%01100000, #30
        .byte #%00001111, #%01111111, #0
        .byte #%01111111, #%01110000, #0
        .byte #%11111100, #%01110000, #0
        .byte #%00000000, #%01110000, #0
        .byte #%00011111, #%01110001, #0
        .byte #%10011100, #%01100000, #0
        .byte #%10011000, #%01000010, #0
        .byte #%10011100, #%00000100, #0
        .byte #%10001111, #%00011000, #0
        .byte #%10000111, #%11100001, #0
        .byte #%11000111, #%11100011, #0
        .byte #%11000111, #%11100011, #0

Room6
        .byte #%11111111, #%10000111, #0
        .byte #%00000001, #%10011111, #0
        .byte #%00110000, #%00011000, #0
        .byte #%00011100, #%00100000, #60
        .byte #%00011110, #%01000000, #0
        .byte #%11011100, #%00000000, #0
        .byte #%11110000, #%11100000, #0
        .byte #%00000000, #%11100000, #0
        .byte #%11110000, #%11000000, #0
        .byte #%01111110, #%11100000, #0
        .byte #%01110011, #%11111000, #0
        .byte #%00000000, #%00000000, #0
        .byte #%00111111, #%11111111, #0
...
Room8
        .byte #%11111111, #%10000111, #0
        .byte #%11000000, #%10000110, #0
        .byte #%10001110, #%10000110, #0
        .byte #%00000110, #%10000010, #80
        .byte #%10000110, #%10000000, #0
        .byte #%10000111, #%11000111, #0
        .byte #%00001111, #%11111111, #0
        .byte #%00111110, #%11110000, #0
        .byte #%00000000, #%11100000, #0
        .byte #%11111000, #%00000000, #0
        .byte #%11111110, #%10000000, #0
        .byte #%11111111, #%10000011, #0
        .byte #%11111111, #%10000111, #0
        .byte #%11111111, #%10000111, #0
        .byte #%11111111, #%10000111, #0
        .byte #%11111111, #%10000111, #0
...
Room9
        .byte #%00000000, #%00000000, #0
        .byte #%00000000, #%00000010, #0
        .byte #%00000000, #%00001110, #0
        .byte #%00001100, #%00011100, #60
        .byte #%00001110, #%00011000, #0
        .byte #%00000110, #%00011100, #0
        .byte #%00000110, #%00011100, #0
        .byte #%00000010, #%00011100, #0
        .byte #%00000000, #%00011000, #0
        .byte #%00000000, #%00011000, #0
        .byte #%00000000, #%00011000, #0
...
Room11
        .byte #%11111111, #%00000011, #0
        .byte #%11111111, #%00000001, #0
        .byte #%11111111, #%00000000, #0
        .byte #%11111111, #%01000000, #120
        .byte #%11100000, #%11100000, #0
        .byte #%10001110, #%11110000, #0
        .byte #%00011111, #%11111000, #0
        .byte #%00001110, #%01111000, #0
        .byte #%00000000, #%00000000, #0
        .byte #%10000000, #%00000000, #0
        .byte #%11100000, #%00000001, #0
        .byte #%11111111, #%00000011, #0
        .byte #%11111111, #%00000011, #0
        .byte #%11111111, #%00000001, #0
        .byte #%11111111, #%00000001, #0
...
Room12
        .byte #%11111111, #%00000011, #0
        .byte #%11111111, #%00000111, #0
        .byte #%11111101, #%00001111, #0
        .byte #%11111000, #%00011111, #50
        .byte #%11111000, #%00111111, #0
        .byte #%11111000, #%00111111, #0
        .byte #%11111101, #%01111111, #0
        .byte #%11110001, #%01111111, #0
        .byte #%11000000, #%00111110, #0
        .byte #%11000000, #%00011110, #0
        .byte #%11000000, #%00001100, #0
        .byte #%11110000, #%00001000, #0
        .byte #%11111100, #%00000000, #0
        .byte #%11111110, #%00000000, #0
        .byte #%11111111, #%00000000, #0
        .byte #%11111111, #%00000001, #0
...
Room13
        .byte #%00000000, #%01110000, #0
        .byte #%11000000, #%11111000, #0
        .byte #%11100000, #%11110000, #0
        .byte #%11000000, #%11000000, #40
        .byte #%10000000, #%00000000, #0
        .byte #%00000000, #%00000000, #0
        .byte #%00000000, #%00000100, #0
        .byte #%00011111, #%00011111, #0
        .byte #%00111111, #%00000001, #0
        .byte #%01111100, #%00000000, #0
        .byte #%01111000, #%00000000, #0
        .byte #%11110000, #%11111110, #0
        .byte #%11000000, #%10000011, #0
        .byte #%11000000, #%10000000, #0
        .byte #%11000000, #%10001000, #0
        .byte #%11111111, #%10000111, #0       
